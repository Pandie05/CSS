...
function butts(e)
{
    ...
    document.querySelector(`#breadcrumbs`).innerHTML= ` <a href="#">CSS</a> > <a href="#">w6</a> > <a href="#">assignment</a> > <a href="#">${e.target.innerText}</a> <style> a {text-decoration: none; color: blue;} </style>`
}
